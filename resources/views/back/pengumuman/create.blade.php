				...
				<div class="card-body">
					<form method="POST" action="{{ route('pengumuman.store') }}">
						...
						<div class="form-group">
							...
							<input type="text" name="nama" class="form-control" id="text" placeholder="Masukkan Nama Pengumuman">
						</div>
						<div class="form-group">
							<label for="link">link</label>
							<input type="text" name="link" class="form-control" id="text" placeholder="Masukkan Link Pengumuman">
						</div>
						<div class="form-group">
